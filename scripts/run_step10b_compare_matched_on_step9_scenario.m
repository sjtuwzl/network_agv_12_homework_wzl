...
% - coop: local + intra-group cooperative + repulsion (Step9-style)
...
legend('Independent', 'Cooperative', 'Location', 'northeast');
title('Matched-scenario comparison on Step9 task');
...
legend('Independent', 'Cooperative', 'Location', 'best');
title('Matched-scenario safety comparison');
exportgraphics(gcf, fullfile(pic_dir, 'compare_matched_step9_scenario_min_dist.png'), 'Resolution', 220);
...
fprintf('Saved matched compare figure(min dist): %s\n', fullfile(pic_dir, 'compare_matched_step9_scenario_min_dist.png'));
